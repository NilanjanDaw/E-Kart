...
For example, seller WS Retail charges Rs 40 for delivery per item if the order value is less than Rs 500. While, orders of Rs 500 or above are delivered free. Please check with individual Sellers to understand their delivery charges.<br />


Why does the delivery date not correspond to the delivery timeline of X-Y business days?
It is possible that the Seller or our courier partners have a holiday between the day your placed your order and the date of delivery, which is based on the timelines shown on the product page. In this case, we add a day to the estimated date. Some courier partners and Sellers do not work on Sundays and this is factored in to the delivery dates.<br />
...
Are there any hidden costs (sales tax, octroi etc) on items sold by Sellers on Ekart?
There are NO hidden charges when you make a purchase on Ekart. List prices are final and all-inclusive. The price you see on the product page is exactly what you would pay.
<br />
...
Seller does not/cannot ship to my area. Why?<br />
...
Does Ekart deliver internationally?
As of now, Ekart doesn't deliver items internationally.<br />
