...
<div class="c1"><a id="opn2" class="C3" href="about.php">ABOUT US</a></div>
<div class="c1"><a id="opn3" class="C3" href="contact.php">CONTACT US</a></div>
<div class="c1"><a id="opn4" class="C3" href="#">Welcome User </a></div>
<div class="c1"><a id="opn5" onclick="delete_cookie()" class="C3" href="divtry.php">LOG OUT</a></div>
</div>
...
<div id="footer" style="background-color: #ffa500; clear: both;text-align: center;">Copyright &copy; Swarnadeep &amp; Nilanjan</div>
...
{
document.cookie="user=; expires=Thu, 10-Aug-1995 00:00:00 GMT";
document.cookie="pwd=; expires=Thu, 10-Aug-1995 00:00:00 GMT";
document.cookie="proid=; expires=Thu, 10-Aug-1995 00:00:00 GMT";alert("32DDDDDD");
}
</script>
<?php
include("footer.php");
